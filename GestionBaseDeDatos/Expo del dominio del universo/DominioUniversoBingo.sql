...
--------------------------------------------------------------------------------------------
----------------------------ELIMINAR DATOS DE UNA TABLA EN CASCADA--------------------------
--------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------
--------------¿CUALES SON LOS USUARIOS QUE LLEVAN MAS DE DOS MESES INSCRITOS? -------------
-------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------
---------------¿CUALES ES LA CANTIDAD DE BINGOS QUE HA GANADO CADA JUGADOR? ---------------
-------------------------------------------------------------------------------------------
...
FROM   PUBLIC.USUARIO
INNER JOIN PUBLIC.GANADOR ON USUARIO.CLI_CODIGO = GANADOR.CLI_CODIGO
INNER JOIN PUBLIC.BINGO ON  BINGO.BIN_NUMERO = USUARIO.BIN_NUMERO
WHERE 
 GANADOR.GAN_CANTIDAD_GANADOS>0;
...
SELECT  
  MIN(BIN_DATE) AS INICIO,
  MAX(BIN_DATE) AS FIN,
  SUM(  40.00 - INSCRIPCION.INC_DESCUENTO) AS TOTAL   
FROM PUBLIC.USUARIO
INNER JOIN PUBLIC.INSCRIPCION ON USUARIO.CLI_CODIGO = INSCRIPCION.CLI_CODIGO
...
-------------------------------------------------------------------------------------------
------------------------LISTA DE LAS PERSONAS CON PAGOS ATRASADOS -------------------------
-------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------
--MOSTRAR UNA LISTA CON LOS USUARIOS QUE TIENE A CARGO CADA ADMINISTRADOR EN CADA UNO DE LOS BINGOS--
-----------------------------------------------------------------------------------------------------
